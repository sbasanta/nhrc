...
@section('content-edit')
  <div class="row justify-content-center">
    ...
    <div class="col-md-8 " style="margin-top:5px;">
      <form method="POST" action="{{route('guideline.update',$guidelines->id)}}" enctype="multipart/form-data" data-parsley-validate>
        ...
        <fieldset class="border border-info rounded">
          <legend class="col-md-4"> Edit Guideline Details </legend>
          ...
          <div class="card" style="background:#FFFFE0;box-shadow:0px 1px 3px gray;padding:20px;">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <textarea  class="form-control" id="etitle" name="etitle"  placeholder="Title in English" required minlength="6"> {{$guidelines->etitle}} </textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <textarea  class="form-control" id="ntitle" name="ntitle"  placeholder="Title in English" required minlength="6"> {{$guidelines->ntitle}} </textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
               ...
               <small id="file1help" class="form-text text-muted">  {{$guidelines->file1}}</small>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-2 offset-md-1">
              ...
              <div class="col-md-8">
                ...
                <small id="file2help" class="form-text text-muted">  {{$guidelines->file2}}</small>
    ...
    <tr><td>Uploaded by:</td><td>{{$guidelines->user->firstname}} {{$guidelines->user->lastname}}</td></tr>
      <tr><td>Upload date:</td><td>{{date('j M Y', strtotime($guidelines->created_at))}}</td></tr>
      <tr><td>Last Updated:</td><td>{{date('j M Y h : i a' , strtotime($guidelines->updated_at))}}</td></tr>
    </table>
        </div>
      </div>
