...
@section('breadcrumb')
    <li class="breadcrumb-item active" aria-current="page">PressRelease</li>
@endsection
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-10">
          <input type="text" class="form-control" id="n_englishtitle" name="n_englishtitle" placeholder="Title in English" required minlength="6">
        </div>
        </div>
        ...
        <div class="col-md-10">
          <input type="text" class="form-control" id="pr_nepalititle" name="pr_nepalititle" placeholder="Title in Nepali" minlength="6">
        </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
          <input type="date"class="form-control" id="pr_publishdate" name="pr_publishdate" required/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="text" class="form-control" id="pr_link" name="pr_link" placeholder="External link" data-parsley-type="url">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="pr_file1" name="pr_file1" placeholder="file to upload" required>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-md-2">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="pr_file2" name="pr_file2" placeholder="file to upload">
          </div>
        </div>
