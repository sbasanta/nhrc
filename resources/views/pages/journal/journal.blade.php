  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">New Journal</h5>
      ...
      <div class="modal-body">
        ...
        <div class="col-md-10">
          <input type="text" class="form-control" id="j_englishtitle" name="j_englishtitle" placeholder="Title in English" required minlength="6">
        </div>
        </div>
        ...
        <div class="col-md-10">
          <input type="text" class="form-control" id="j_nepalititle" name="j_nepalititle" placeholder="Title in Nepali" minlength="6">
        </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
          <input type="date"class="form-control" id="j_publishdate" name="j_publishdate" required/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="text" class="form-control" id="j_link" name="j_link" placeholder="External link" data-parsley-type="url">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="j_file1" name="j_file1" placeholder="file to upload" required>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-md-2">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="j_file2" name="j_file2" placeholder="file to upload">
          </div>
        </div>
