...
@section('title', '| RadioProgram')
@section('breadcrumb')
    <li class="breadcrumb-item active" aria-current="page">Publication</li>
      <li class="breadcrumb-item active" aria-current="page">Radio Program</li>
@endsection
@section('content')
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">New Radio Program</h5>
      ...
      <div class="modal-body">
        ...
        <div class="col-md-10">
          <input type="text" class="form-control" id="rp_englishtitle" name="rp_englishtitle" placeholder="Title in English" required minlength="6">
        </div>
        </div>
        ...
        <div class="col-md-10">
          <input type="text" class="form-control" id="rp_nepalititle" name="rp_nepalititle" placeholder="Title in Nepali" minlength="6">
        </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
          <input type="date"class="form-control" id="rp_publishdate" name="rp_publishdate" required/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="text" class="form-control" id="rp_link" name="rp_link" placeholder="External link" data-parsley-type="url">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="rp_file1" name="rp_file1" placeholder="file to upload" required>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-md-2">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="rp_file2" name="rp_file2" placeholder="file to upload">
          </div>
        </div>
