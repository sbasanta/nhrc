  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">New Notice</h5>
      ...
      <div class="modal-body">
        ...
        <div class="col-md-10">
          <input type="text" class="form-control" id="n_nepalititle" name="n_nepalititle" placeholder="Title in Nepali" minlength="6">
        </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
          <input type="date"class="form-control" id="n_publishdate" name="n_publishdate" required/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="text" class="form-control" id="n_link" name="n_link" placeholder="External link" data-parsley-type="url">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="n_file1" name="n_file1" placeholder="file to upload" required>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-md-2">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="n_file2" name="n_file2" placeholder="file to upload">
          </div>
        </div>
