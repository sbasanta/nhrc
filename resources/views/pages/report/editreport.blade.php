...
@section('breadcrumb')
  ...
  {{-- <li class="breadcrumb-item active" aria-current="page">{{$report->etitle}}</li> --}}
...
@section('content-edit')
  <div class="row justify-content-center">
        ...
        <fieldset class="border border-info rounded">
          ...
          <div class="card" style="background:#FFFFE0;box-shadow:0px 1px 3px gray;padding:20px;">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <textarea  class="form-control" id="ntitle" name="ntitle"  placeholder="Title in Nepali"> {{$report->ntitle}} </textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
               ...
               <small id="file1help" class="form-text text-muted">  {{$report->file1}}</small>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-2 offset-md-1">
              ...
              <div class="col-md-8">
                ...
                <small id="file2help" class="form-text text-muted">  {{$report->file2}}</small>
    ...
    <tr><td>Uploaded by:</td><td>{{$report->user->firstname}} {{$report->user->lastname}}</td></tr>
      <tr><td>Upload date:</td><td>{{date('j M Y', strtotime($report->created_at))}}</td></tr>
      <tr><td>Last Updated:</td><td>{{date('j M Y h : i a' , strtotime($report->updated_at))}}</td></tr>
    </table>
        </div>
      </div>
