  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">New Newsletters</h5>
      ...
      <div class="modal-body">
        ...
        <div class="col-md-10">
          <input type="text" class="form-control" id="nl_englishtitle" name="nl_englishtitle" placeholder="Title in English" required minlength="6">
        </div>
        </div>
        ...
        <div class="col-md-10">
          <input type="text" class="form-control" id="nl_nepalititle" name="nl_nepalititle" placeholder="Title in Nepali" minlength="6">
        </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
          <input type="date"class="form-control" id="nl_publishdate" name="nl_publishdate" required/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="text" class="form-control" id="nl_link" name="nl_link" placeholder="External link" data-parsley-type="url">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="nl_file1" name="nl_file1" placeholder="file to upload" required>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-md-2">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" id="nl_file2" name="nl_file2" placeholder="file to upload">
          </div>
        </div>
